...
def get_elves(grid):
    ...
    for elf in list(map(tuple, np.argwhere(grid == "E"))):
        ...
        elf = Unit(position=elf, variety="E")
        elves.append(elf)
...
if __name__ == "__main__":
    main("test_0.txt", 27730)
    main("test_1.txt", 36334)
    main("test_2.txt", 39514)
    main("test_3.txt", 27755)
    main("test_4.txt", 28944)
    main("test_5.txt", 18740)
    main("input.txt")
