...
def solve(initial_state, rules):
    """
    A pattern stabilizes after ~100 generations.  From this point the plants
    shift to the right by 1 every iteration.
    """
    ...
    return sum({element + (50000000000 - 100) for element in generation})
